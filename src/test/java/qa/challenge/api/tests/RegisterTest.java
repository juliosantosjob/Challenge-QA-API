...
import static qa.challenge.api.utils.Helpers.*;
...
public class RegisterTest extends BaseTest {
    ...
    public void registrationSuccessful() {
        NewUsersModel newUser = getRandomUser(true);
    ...
    @Test
    @Order(6)
    @Tag("cadastro_email_existente")
    @DisplayName("Cenário 06: Deve falhar ao realizar cadastro com e-mail existente")
